...
exports.condicionControlador = void 0;
const conexionBD_1 = __importDefault(require("../../conexionBD"));
class CondicionControlador {
    listar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const condicion = yield conexionBD_1.default.query('SELECT * FROM condiciones');
            res.json(condicion);
        });
    }
    crear(req, res) {
...
exports.condicionControlador = new CondicionControlador();
